    ...
    >
        <form class="h-100" @submit.prevent="handleSubmitted">
            ...
            <div class="input-group input-group-sm flex-nowrap">
                ...
                <button 
                    class="btn btn-sm btn-outline-primary d-inline-flex align-items-center SharpSearch__button" 
                    tabindex="0"
                    type="submit"
                    @click="handleSearchButtonClicked"
                >
                    <!-- heroicons: solid/20/search -->
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" class="me-1">
    ...
    export default {
        ...
        methods: {
            ...
            handleSearchButtonClicked(e) {
                // При нажатии на кнопку поиска также эмитим событие для применения фильтров
                this.$emit('submit', this.search);
